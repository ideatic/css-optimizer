...
class css_color
{
    ...
    private function _parse_rgba($match): void
    {
    ...
    private function _parse_hex($match): void
    {
    ...
    private function _parse_hex_short($match): void
    {
     ...
     * @return string
     */
    private function _parse_hsl($match): string
    {
     ...
     * @return string
     */
    public function to_rgb($alpha = true): string
    {
        if ($alpha && $this->a != 1) {
     ...
     * @return string
     */
    public function to_hex($allow_short = true): string
    {
        $hex = "#";
     ...
     * @return self
     */
    public static function create(string $color): css_color
    {
